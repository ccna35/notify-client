export default function Footer() {
  return (
    // <footer className="w-full py-4 px-2 sm:px-6 lg:px-8 bg-slate-950 text-white dark:border-t-2 border-t-slate-900">
    //   <div className="container">
    //     This is a footer. This is a footer. This is a footer.
    //   </div>
    // </footer>

    <footer className="bg-white dark:bg-slate-950 pt-4 pb-8 xl:pt-8 border-t dark:border-t-slate-800">
      <div className="max-w-screen-lg px-4 mx-auto text-slate-800 xl:max-w-screen-xl sm:px-6 md:px-8 dark:text-gray-300">
        <ul className="flex flex-wrap justify-center pb-8 text-lg font-light">
          <li className="w-1/2 md:w-1/3 lg:w-1/3">
            <div className="text-center">
              <h2 className="text-slate-800 dark:text-gray-200 text-md uppercase mb-4 font-semibold">
                Components
              </h2>
              <ul>
          ...
          <li className="w-1/2 md:w-1/3 lg:w-1/3">
            <div className="text-center">
              <h2 className="text-slate-800 font-semibold dark:text-gray-200 text-md uppercase mb-4">
                Contacts
              </h2>
              <ul>
                <li className="mb-4 transition-colors duration-200 hover:text-gray-800 dark:hover:text-white">
