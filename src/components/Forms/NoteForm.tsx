    ...
    >
      <div className="flex flex-col gap-6">
        <div className="flex flex-col gap-2">
            ...
            <Input
              ...
              register={register("note_title", {
                ...
                validate: {
                  maxContent: (val) => {
                    return (
                      val.length <= 100 || "Title should be 100 characters max"
                    );
                  },
                },
              })}
          ...
          {errors.note_title && (
            <small className="error w-fit">{errors.note_title.message}</small>
          )}
        </div>
        <div className="flex flex-col gap-2">
          <textarea
            ...
            {...register("note_body", {
              ...
              validate: {
                maxContent: (val) => {
                  return (
                    val.length <= 1000 || "Text should be 1000 characters max"
                  );
                },
              },
            })}
          ...
          {errors.note_body && (
            <small className="error w-fit">{errors.note_body.message}</small>
          )}
        </div>
      </div>
      <div className="flex flex-col gap-6">
